                    ...
                    <form method="POST" action="{{route('assignment.update', $assignment)}}">
                        ...
                        <div>
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="name" value="{{old('name') ?? $assignment->name}}" placeholder="Name">
                            </div>
                        </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="form-select" name="stat_id">
                                    ...
                                    @foreach($stats as $stat)
                                        <option value="{{$stat->id}}" {{ old('stat') ?? $assignment->stat_id == $stat->id ? 'selected' : ''}}>
                                            {{$stat->name}}
                                        </option>
                                    @endforeach
                                </select>
